...
function ProductPage() {
    return ( 
        <>
         ...
         productDesc="Our ultra-fast flagship trading platform with streaming market data,
         ...
         tryDemo="Coin"/>
         <RightSection imageURL="media/images/kiteconnect.svg" productName="Kite Connect API" 
